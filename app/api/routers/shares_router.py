...
def share_note(
    note_id: int, payload: ShareRequest, db: DBSession, user: CurrentUser
):
...
def unshare_note(
    note_id: int, target_user_id: int, db: DBSession, user: CurrentUser
):
...
def share_label(
    label_id: int, payload: ShareRequest, db: DBSession, user: CurrentUser
):
...
def unshare_label(
    label_id: int, target_user_id: int, db: DBSession, user: CurrentUser
):
